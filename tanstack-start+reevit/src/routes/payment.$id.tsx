...
import { ArrowRight02Icon, CheckmarkCircle02Icon, Home01Icon } from '@hugeicons/core-free-icons'
import { Button } from '../components/ui/button'
import { Card, CardContent } from '../components/ui/card'

export const Route = createFileRoute('/payment/$id')({ component: PaymentStatusPage })
      ...
      <Card className="max-w-lg w-full text-center">
        <CardContent className="pt-8 pb-8">
          ...
          <div className="p-4 bg-muted rounded-lg mb-8">
            ...
            <p className="font-mono text-lg text-primary break-all">{id}</p>
          </div>
